        ...
        addOverLay(nodeId) {
            ...
            !this.workStatus &&
                (this.nodeList = elementRegistry.filter(
                    (item) =>
                        item.type === 'bpmn:UserTask' || item.type === 'bpmn:Task' || item.type === 'bpmn:ServiceTask',
                ));
            this.workStatus && (this.nodeList = elementRegistry.filter((item) => item.type === 'bpmn:EndEvent'));
