    ...
    <div v-loading="isView" class="flow-containers" :class="{ 'view-mode': isView }">
        <el-container style="height: 100%">
            <el-header style="border-bottom: 1px solid #dddddd; height: auto; padding: 0 10px">
                <div style="display: flex; padding: 5px 0px; justify-content: space-between">
                    ...
                    <div>
                        <el-button class="operate-btn" size="mini" icon="el-icon-download" @click="saveXML(true)"
                            >下载xml</el-button
                        >
                        <el-button class="operate-btn" size="mini" icon="el-icon-picture" @click="saveImg('svg', true)"
                            >下载svg</el-button
                        >
        ...
        <el-dialog :visible.sync="xmlVisible" title="XML" :fullscreen="false" top="10vh">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button icon="el-icon-document" v-clipboard:copy="process.xml" v-clipboard:success="onCopy"
                    >复 制</el-button
                >
...
import language_tools from 'brace/ext/language_tools';
import xml_tool from 'brace/mode/xml';
import chrome_tools from 'brace/theme/chrome';
// 引入camunda的节点文件
...
export default {
    ...
    methods: {
        ...
        editorInit: function () {
            language_tools; // language extension prerequsite...
            xml_tool; // language
            chrome_tools;
        },
        newDiagram() {
