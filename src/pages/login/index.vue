<template>
    <div class="login w100 h100 ub ub-ac ub-pc">
        <div class="main ub ub-ac ub-pc">
            ...
            <div class="form">
                <p v-if="failed" class="warn-tips">
                    您的账号输入失败次数过多，系统将锁定账号{{ safetyInfo.lockTime
                    }}{{ safetyInfo.lockTimeUnit | limitUnit }}后解除，或您可<span
                        :class="{ 'admin-phone': safetyInfo.adminPhone }"
                        @click="
                            () => {
                                safetyInfo.adminPhone && (adminDialog = true);
                            }
                        "
                        >联系管理员进行申诉</span
                    >
                ...
                <div class="login-form">
                    ...
                    >
                        ...
                        <div class="submit">
                            <el-button :disabled="isLogin" class="w100" type="primary" @click="validUser">{{
                                isLogin ? '正在登录中，请稍后...' : '登 录'
                            }}</el-button>
...
import { get_security_policy, login, sendVerifyCode } from '@/server/login/index.js';
import logoAddress from '../../assets/img/logo.png';
export default {
    name: 'Login',
    components: {
        AdminDialog,
    ...
    data() {
        return {
            ...
            safetyInfo: {
                ...
                logoAddress: logoAddress, // logo 地址
                adminPhone: '', // 管理员联系方式
                lockTime: '', // 锁定时间
    ...
    .main {
        ...
        .title-info {
            ...
            p {
                ...
                font-family: Hkxzy;
                color: #3579ec;
                text-shadow: 10px 10px 4px rgba(13, 64, 133, 0.1);
                letter-spacing: 8px;
            }
        }
        .form {
