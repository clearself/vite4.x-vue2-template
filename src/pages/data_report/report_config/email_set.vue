<template>
    <div class="event event-wrapper" style="box-sizing: border-box">
        <div class="attendance-list content btn-1366" style="box-sizing: border-box; margin-top: 0">
...
<script>
import { get_email_config, add_email_config } from '@/server/reporting_platform/setting.js';
...
.from-box ::v-deep .el-date-editor.el-input {
