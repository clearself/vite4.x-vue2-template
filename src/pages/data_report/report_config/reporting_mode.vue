<template>
    <div class="event event-wrapper report-platform" style="box-sizing: border-box; height: 100%">
        <div
            class="attendance-list content"
            style="box-sizing: border-box; height: 100%; padding-bottom: 100px; margin-top: 0; overflow-y: auto"
        >
                ...
                <el-form :model="timeForm" :rules="rules" ref="timeForm" :inline="true" class="unit set">
                    ...
                    <div class="w100" v-if="timeForm.type == 0">
                        <el-form-item
                            style="width: 48%"
                            label="外部网络攻击topic："
                            prop="externalNetworkAttackTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.externalNetworkAttackTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="内部网络攻击topic："
                            prop="internalNetworkAttackTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.internalNetworkAttackTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="证联网接入区安全告警topic："
                            prop="networkAccessZoneAlarmTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.networkAccessZoneAlarmTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="异常外连topic："
                            prop="abnormalExternalConnectionTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.abnormalExternalConnectionTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="DDOS攻击topic："
                            prop="ddosAttackTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.ddosAttackTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="恶意代码感染topic："
                            prop="maliciousCodeInfectionTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.maliciousCodeInfectionTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="恶意邮件topic："
                            prop="maliciousMailTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.maliciousMailTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 48%"
                            label="仿冒/钓鱼网站topic："
                            prop="fakePhishingWebsiteTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.fakePhishingWebsiteTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                        ...
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.fakeAppTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 50%"
                            label="网站篡改topic："
                            prop="websiteTamperingTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.websiteTamperingTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                        <el-form-item
                            style="width: 50%"
                            label="上报统计校验topic："
                            prop="statisticalVerificationTopic"
                            :label-width="formLabelWidth"
                        >
                            <el-input
                                placeholder="请输入"
                                clearable
                                v-model.trim="timeForm.statisticalVerificationTopic"
                                size="small"
                            ></el-input>
                        </el-form-item>
                    </div>
                    ...
                    <div class="w100" v-if="timeForm.type == 1">
                        <div
                            class="ub ub-ac ub-pj http-item"
                            :class="{
                                noBorder:
                                    timeForm.multipointConfigArr.length == 1 ||
                                    index === timeForm.multipointConfigArr.length - 1,
                                noBg: timeForm.isMultipoint == 0,
                            }"
                            v-for="(item, index) in timeForm.multipointConfigArr"
                            :key="index"
                            ...
                            <div class="ub ub-ver ub-f1">
                                <div style="margin-bottom: 22px">
                                    <el-form-item
                                        style="width: 40%"
                                        label="IP白名单："
                                        :label-width="formLabelWidthHttps"
                                    >
                                        <el-input
                                            placeholder="请输入"
                                            clearable
                                    ...
                                    >
                                        <i
                                            class="iconfont"
                                            :class="{
                                                'icon-selected active': item.type == 1,
                                                'icon-circle': item.type == 0,
                                            }"
                                        ></i>
...
<script>
import { get_report_set, add_report_set } from '@/server/reporting_platform/setting.js';
export default {
    name: 'ReportSet',
    data() {
        var reg = /^[1-9]\d*$/;
