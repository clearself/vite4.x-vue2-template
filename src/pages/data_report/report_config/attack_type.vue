                    ...
                    <template slot-scope="scope">
                        <div>
                            <div style="display: inline;" v-for="(item,index) in scope.row.ruleItems" :key="index">
                                ...
                                <span class="mapping-or" v-if="index != scope.row.ruleItems.length-1" style="margin: 0 10px;">or</span>
                            </div>
                        </div>
                    </template>
                </el-table-column>
                                ...
                                <div class="ub ub-f1 ub-pj mapping-item" style="padding:5px;" v-for="(_item,index) in formData.contentArr" :key="index">
                                    <div class="ub ub-ac ub-f1">
                                        ...
                                        >
                                            ...
                                            <el-select clearable size="small" v-model="_item.field" placeholder="请选择" @change="changeFields(_item.field,_item)">
            ...
            public_page(data).then(res => {
                ...
                this.tableData = res.records.map(e => {
                    let obj = {
                        ...
                        bigName: e.bigName,
                        type: e.type,
                        ruleItems: e.ruleItems ? e.ruleItems : []
                    }
                    return obj
                })
