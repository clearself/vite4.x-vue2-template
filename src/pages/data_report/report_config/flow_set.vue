<template>
    <div class="event event-wrapper report-platform" style="box-sizing: border-box">
        <div class="attendance-list content btn-1366" style="box-sizing: border-box; height: 100%; margin-top: 0">
...
<script>
import { get_flow, add_flow } from '@/server/reporting_platform/setting.js';
