        ...
        <div class="drawerWraper">
            <el-form ref="ruleForm" :rules="rules" :model="ruleForm">
                ...
                <el-form-item
                    ...
                    :rules="ruleForm.local_device_type == '02' ? { required: true, message: '请选择本地外连系统类型', trigger: 'change' } : {}">
                    <el-select
                        style="width: 220px"
                        clearable
                        size="small"
                ...
                <el-form-item
                    ...
                    :label-width="formLabelWidth"
                    :rules="ruleForm.local_device_type == '02' ? { required: true, message: '请输入本地外连系统名称', trigger: 'blur' } : {}">
            ...
            handler(newVal) {
                if (newVal != '02') {
                    if (this.$refs.ruleForm) {
                        this.$refs.ruleForm.clearValidate(['local_system_type'])
                        this.$refs.ruleForm.clearValidate(['local_system_name'])
                    }
                }
            }
        },
