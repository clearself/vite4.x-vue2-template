    ...
    <el-drawer
        ...
        <div class="drawerWraper">
            <el-form ref="ruleForm" :rules="rules" :model="ruleForm">
                ...
                <el-form-item label="被攻击类系统类型：" prop="destination_system_type" :label-width="formLabelWidth">
                    <el-select
                        ...
                        <el-option v-for="item in beAttackOpt" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                    <el-select
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                destination_system_type: [{ required: true, message: '请选择被攻击类系统类型', trigger: 'change' }],
