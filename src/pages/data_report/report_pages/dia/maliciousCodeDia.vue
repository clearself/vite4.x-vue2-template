        ...
        <div class="drawerWraper">
            <el-form ref="ruleForm" :rules="rules" :model="ruleForm">
                ...
                <el-form-item
                    ...
                    :rules="ruleForm.device_type == '02' ? { required: true, message: '请选择感染系统类型', trigger: 'change' } : {}">
                    <el-select
                        style="width: 220px"
                        clearable
                        size="small"
                ...
                <el-form-item
                    ...
                    prop="system_name"
                    :label-width="formLabelWidth"
                    :rules="ruleForm.device_type == '02' ? { required: true, message: '请输入感染系统名称', trigger: 'blur' } : {}">
