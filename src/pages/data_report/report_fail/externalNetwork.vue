<template>
    <div class="event reporting_platform" style="box-sizing: border-box;overflow-y: hidden;">
        <div class="ub w100" style="box-sizing: border-box;">
            <SearchTop class="seaTopBox" @search="searchData" @reset="reset">
                <el-col :md="12" :lg="8" :xl="6">
                    <el-form :model="get_params">
                        <el-form-item label="上报状态：" :label-width="formLabelWidthSearch">
                            <el-select style="width: 100%;" clearable size="small" v-model.trim="get_params.status" placeholder="请选择">
                                <el-option v-for="item in sendStatusList" :key="item.value + item.label" :label="item.label" :value="item.value">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    </el-form>
