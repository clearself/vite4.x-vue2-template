    ...
    <div class="ub w100" style="margin-top: 10px; min-height: 400px">
                        ...
                        >
                            <transition-group>
                                <li
                                    ...
                                    :class="
                                        element.fieldName === 'alarmTime' || element.fieldName === 'message'
                                            ? 'forbid'
                                            : ''
                                    "
                                ...
                                >
                                    <div class="ub ub-ac list-title">
                                        ...
                                        <div class="open-box" v-if="element.type != 4">
                                            <i
                                                v-if="
                                                    element.fieldName !== 'alarmTime' &&
                                                    element.fieldName !== 'message' &&
                                                    element.fieldName !== 'isAlarm'
                                                "
                                        ...
                                        <div
                                            class="ub ub-f1 line1"
                                            style="font-size: 12px; padding-left: 10px"
                                            :style="{ paddingLeft: element.type == 4 ? '25px' : '' }"
                                        >
                                            {{ element.name }}
                                        </div>
                    ...
                    <div class="w100 drag" style="margin-top: 10px; margin-bottom: 40px; max-height: 3000px">
                        <ul>
                            <li
                                ...
                                v-for="(element, index) in filterCanFields.trim()
                                    ? listCanSelect.filter((it) => it.name.includes(filterCanFields.trim()))
                                    : listCanSelect"
                                :key="index"
                            >
                                <div class="ub ub-ac list-title">
        ...
        <div class="ub ub-f1 ub-ver expert-right" style="overflow-x: hidden">
            <div class="ub ub-pj w100 mb-1">
                ...
                <div style="flex: 1; text-align: right">
                    ...
                    <el-button
                        class="custom-btn"
                        size="small"
                        icon="iconfont icon-sousuotiaojianbaocun"
                        type="primary"
                        @click="handleSaveLogIds"
                    ...
                    <el-button
                        class="custom-btn"
                        size="small"
                        icon="iconfont icon-zancunliebiao"
                        type="primary"
                    ...
                    <el-button
                        ...
                        type="primary"
                        @click="$parent.highlightDialog = true"
                        >配置高亮词</el-button
                    >
                ...
                >
                                ...
                                <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                                    <div>
                                        <p
                                            ...
                                            @click="
                                                equalVal({
                                                    ...
                                                    name: item.name,
                                                    value:
                                                        item.fieldName == 'requestTimeNs' ||
                                                        item.fieldName == 'responseTimeNs'
                                        ...
                                        <p
                                            ...
                                            v-if="
                                                ['ip'].some((keyWord) => item.fieldName.toLowerCase().includes(keyWord))
                                            "
                    ...
                    <el-table-column label="操作" align="center" width="220" fixed="right" class-name="deepBg">
                        <template slot-scope="scope">
                            ...
                            <el-button @click="createPackTask(scope.row)" type="text" size="small"
                                >下载PCAP包任务</el-button
                            >
            ...
            <div
                ...
                class="pagination pag"
                style="padding: 0px !important; text-align: right"
            >
                <el-pagination
                    background
                    @size-change="handleSizeChange"
            ...
            <div class="container see" v-if="seeTaskDialog">
                ...
                <el-descriptions size="mini" title="" :column="2" border>
                    ...
                    <el-descriptions-item label="客户端IP">
                        <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                            <div>
                                ...
                                <p
                                    style="margin-top: 10px"
                                    @click="jumpThreat(seeDetail.clientIp)"
                                    class="ub ub-ac click-btn"
                                >
                                    <i class="iconfont icon-chaxunqingbao" style="font-size: 12px"></i>
                                    <span>查询情报</span>
                            ...
                            >
                                <i
                                    ...
                                    :style="{
                                        ...
                                        ].filter((co) => co.type == seeDetail.clientIpIsSpite)[0].color,
                                    }"
                    ...
                    <el-descriptions-item label="客户端IP(ipv6)">
                        <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                            <div>
                                ...
                                <p
                                    style="margin-top: 10px"
                                    @click="jumpThreat(seeDetail.clientIpV6)"
                                    class="ub ub-ac click-btn"
                                >
                                    <i class="iconfont icon-chaxunqingbao" style="font-size: 12px"></i>
                                    <span>查询情报</span>
                                ...
                                <i
                                    ...
                                    :style="{
                                        color: [
                                            ...
                                            { type: '恶意', color: '#ff0000' },
                                            { type: '未知', color: '#7c7c7c' },
                                        ].filter((co) => co.type == seeDetail.clientIpV6IsSpite)[0].color,
                                    }"
                    ...
                    <el-descriptions-item label="服务器IP">
                        <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                            <div>
                                ...
                                <p
                                    style="margin-top: 10px"
                                    @click="jumpThreat(seeDetail.serverIp)"
                                    class="ub ub-ac click-btn"
                                >
                                    <i class="iconfont icon-chaxunqingbao" style="font-size: 12px"></i>
                                    <span>查询情报</span>
                                ...
                                <i
                                    ...
                                    :style="{
                                        color: [
                                            ...
                                            { type: '恶意', color: '#ff0000' },
                                            { type: '未知', color: '#7c7c7c' },
                                        ].filter((co) => co.type == seeDetail.serverIpIsSpite)[0].color,
                                    }"
                    ...
                    <el-descriptions-item label="服务器IP(ipv6)">
                        <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                            <div>
                                ...
                                <p
                                    style="margin-top: 10px"
                                    @click="jumpThreat(seeDetail.serverIpV6)"
                                    class="ub ub-ac click-btn"
                                >
                                    <i class="iconfont icon-chaxunqingbao" style="font-size: 12px"></i>
                                    <span>查询情报</span>
                                ...
                                <i
                                    ...
                                    :style="{
                                        color: [
                                            ...
                                            { type: '恶意', color: '#ff0000' },
                                            { type: '未知', color: '#7c7c7c' },
                                        ].filter((co) => co.type == seeDetail.serverIpV6IsSpite)[0].color,
                                    }"
                    ...
                    <el-descriptions-item label="请求时间">{{
                        seeDetail.requestTimeNs | formatText
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应时间">{{
                        seeDetail.responseTimeNs | formatText
                    }}</el-descriptions-item>
                    ...
                    <el-descriptions-item label="请求全URL">
                        <el-popover popper-class="add-search" placement="bottom" title="" trigger="click">
                            <div>
                                ...
                                <p
                                    style="margin-top: 10px"
                                    @click="jumpThreat(seeDetail.requestFullUrl)"
                                    class="ub ub-ac click-btn"
                                >
                                    <i class="iconfont icon-chaxunqingbao" style="font-size: 12px"></i>
                                    <span>查询情报</span>
                            ...
                            <p
                                ...
                                slot="reference"
                                v-html="seeDetail.requestFullUrl"
                            ></p>
                        </el-popover>
                    </el-descriptions-item>
                ...
                <el-descriptions size="mini" title="" :column="1" border>
                    <el-descriptions-item label="请求url" v-if="seeDetail.requestUrl">{{
                        seeDetail.requestUrl
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求主机信息" v-if="seeDetail.requestHost">{{
                        seeDetail.requestHost
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求客户端代理信息" v-if="seeDetail.requestUserAgent">{{
                        seeDetail.requestUserAgent
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求内容类型" v-if="seeDetail.requestContentType">{{
                        seeDetail.requestContentType
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求cookie" v-if="seeDetail.requestCookie">{{
                        seeDetail.requestCookie
                    }}</el-descriptions-item>
                    <el-descriptions-item label="访问来源" v-if="seeDetail.requestReferer">{{
                        seeDetail.requestReferer
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求链接信息" v-if="seeDetail.requestConnection">{{
                        seeDetail.requestConnection
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求接收协议" v-if="seeDetail.requestAcceptCharset">{{
                        seeDetail.requestAcceptCharset
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求接受编码" v-if="seeDetail.requestAcceptEncoding">{{
                        seeDetail.requestAcceptEncoding
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求接受语言" v-if="seeDetail.requestAcceptLanguage">{{
                        seeDetail.requestAcceptLanguage
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求内容长度" v-if="seeDetail.requestContentLength">{{
                        seeDetail.requestContentLength
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求代理认证" v-if="seeDetail.requestProxyAuthorization">{{
                        seeDetail.requestProxyAuthorization
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求通道" v-if="seeDetail.requestVia">{{
                        seeDetail.requestVia
                    }}</el-descriptions-item>
                    <el-descriptions-item label="requestRang" v-if="seeDetail.requestRang">{{
                        seeDetail.requestRang
                    }}</el-descriptions-item>
                    <el-descriptions-item label="requestIFRANG" v-if="seeDetail.requestIfRang">{{
                        seeDetail.requestIfRang
                    }}</el-descriptions-item>
                    <!-- <el-descriptions-item label="请求负载" v-if="seeDetail.requestPayload">{{seeDetail.requestPayload}}</el-descriptions-item> -->
                    <el-descriptions-item label="同Id" v-if="seeDetail.requestId">{{
                        seeDetail.requestId
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求认证信息" v-if="seeDetail.requestAuth">{{
                        seeDetail.requestAuth
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求接收类型" v-if="seeDetail.requestAccept">{{
                        seeDetail.requestAccept
                    }}</el-descriptions-item>
                    <el-descriptions-item label="HTTP请求类型" v-if="seeDetail.requestMethod">{{
                        seeDetail.requestMethod
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求其他数据" v-if="seeDetail.requestOtherData">{{
                        seeDetail.requestOtherData
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求转发" v-if="seeDetail.requestXForwardedFor">{{
                        seeDetail.requestXForwardedFor
                    }}</el-descriptions-item>
                    <el-descriptions-item label="错误信息" v-if="seeDetail.errorInfo">{{
                        seeDetail.errorInfo
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求协议组" v-if="seeDetail.requestClass">{{
                        seeDetail.requestClass
                    }}</el-descriptions-item>
                    <el-descriptions-item label="请求域名" v-if="seeDetail.requestDomain">{{
                        seeDetail.requestDomain
                    }}</el-descriptions-item>
                </el-descriptions>
                ...
                <el-descriptions size="mini" title="" :column="1" border>
                    <el-descriptions-item label="响应版本号" v-if="seeDetail.responseVersion">{{
                        seeDetail.responseVersion
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应状态码" v-if="seeDetail.responseStatusCode">{{
                        seeDetail.responseStatusCode
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应服务" v-if="seeDetail.responseServer">{{
                        seeDetail.responseServer
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应设置COOKIE" v-if="seeDetail.responseSetCookie">{{
                        seeDetail.responseSetCookie
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应内容类型" v-if="seeDetail.responseContentType">{{
                        seeDetail.responseContentType
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应链接信息" v-if="seeDetail.responseConnection">{{
                        seeDetail.responseConnection
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应内容长度" v-if="seeDetail.responseContentLength">{{
                        seeDetail.responseContentLength
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应内容配置" v-if="seeDetail.responseContentDisposition">{{
                        seeDetail.responseContentDisposition
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应内容编码" v-if="seeDetail.responseContentEncoding">{{
                        seeDetail.responseContentEncoding
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应重定向" v-if="seeDetail.responseLocation">{{
                        seeDetail.responseLocation
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应代理认证" v-if="seeDetail.responseProxyAuthorization">{{
                        seeDetail.responseProxyAuthorization
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应通道" v-if="seeDetail.responseVia">{{
                        seeDetail.responseVia
                    }}</el-descriptions-item>
                    <el-descriptions-item label="认证网站" v-if="seeDetail.responseWwwAuthorization">{{
                        seeDetail.responseWwwAuthorization
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应其他数据" v-if="seeDetail.responseOtherData">{{
                        seeDetail.responseOtherData
                    }}</el-descriptions-item>
                    <!-- <el-descriptions-item label="响应负载" v-if="seeDetail.responsePayload">{{seeDetail.responsePayload}}</el-descriptions-item> -->
                    <el-descriptions-item label="响应ttl" v-if="seeDetail.responseTtl">{{
                        seeDetail.responseTtl
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应别名" v-if="seeDetail.responseCName">{{
                        seeDetail.responseCName
                    }}</el-descriptions-item>
                    <el-descriptions-item label="响应计数" v-if="seeDetail.responseCount">{{
                        seeDetail.responseCount
                    }}</el-descriptions-item>
                </el-descriptions>
...
export default {
    ...
    methods: {
                ...
                origin: [
                    {
                        connect: 'and',
                        children: [
                            { field: item.key, operator: '=', value: item.value, dataType: 1, attrType: item.attrType },
                        ],
                    },
                ],
        ...
        onMove(e) {
            ...
            if (e.relatedContext.element.fieldName === 'alarmTime' || e.relatedContext.element.fieldName === 'message')
                return false;
            return true;
        },
        top10Show(element) {
