                ...
                <div style="position: relative; left: 0; top: 0; width: 100%; height: 100%; overflow-y: auto">
                    <div class="ub ub-pe w100">
                        ...
                        <div class="ub">
                            ...
                            <el-button icon="el-icon-delete" type="danger" size="small" @click="handleClearAll"
                                >清空列表</el-button
                            >
                        </div>
                    </div>
                    <div class="drawer-pad">
                        ...
                        <div style="position: relative">
                            ...
                            <div v-if="conditionShow" class="condition-area">
                                <ConditionRules :select-data="selectAll" :treeData="treeData" />
                                <div class="split-line"></div>
                                <div class="ub ub-pe footer" style="margin-top: 20px">
                                    <el-button style="margin-right: 10px" size="small" @click="conditionShow = false"
                                        >取消</el-button
                                    >
                                    <Debounce :time="1500" :isDebounce="2">
                                        <el-button @click.native="addFilterCondition" size="small" type="primary">{{
                        ...
                        <div class="ub ub-pe" style="margin-bottom: 10px">
                            <div class="set-header" @click="transferDialog = true">
                                <span
                                    ...
                                    class="iconfont icon-zidingyibiaotou"
                                ></span>
                                <span>自定表头</span>
                            </div>
                        </div>
                                    ...
                                    <template slot-scope="scope">
                                        <div>
                                            ...
                                            >
                                                    ...
                                                    <p
                                                        ...
                                                        @click="
                                                            equalVal({
                                                                ...
                                                                attrType: item.type,
                                                                value:
                                                                    item.code == 'requestTimeNs' ||
                                                                    item.code == 'responseTimeNs'
                                                ...
                                                <p slot="reference" v-if="item.code === 'aDate'" style="color: #00c0ff">
                                                    {{ scope.row[item.code] }}
                                                </p>
                                                <p
                                                    slot="reference"
                                                    :style="{
                                                        cursor: ['srcIp', 'desIp'].includes(item.code)
                                                            ? 'pointer'
                                                            : 'default',
                                                    }"
                                                    v-else
                                                    @click="jumpAsset(item, scope.row[item.code])"
                                                >
                                                    {{ scope.row[item.code] }}
                                                </p>
                                            </el-popover>
                                ...
                                >
                                    <template slot-scope="scope">
                                        <el-button @click="createPackTask(scope.row)" type="text" size="small"
                                            >下载PCAP包任务</el-button
                                        >
                                        <el-button @click="handleClear(scope.row)" type="text" size="small"
                                            >删除</el-button
                                        >
                                    </template>
                                </el-table-column>
...
import { getStashField, getStashList, updateStashFields, clearStashFields } from '@/server/data_manage/stash.js';
import { getLogById, getKey, downloadLogPacket, getFilterSql } from '@/server/stream_data_center/data_manage.js';
import {
    getLogStorageField,
    pageLogStorage,
    deleteLogStorage,
