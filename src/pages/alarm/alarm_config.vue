<template>
    <div class="list">
        <SearchTop
            @search="searchCheck"
            @reset="reset"
            style="border-top-left-radius: 0; border-top-right-radius: 0; box-shadow: none"
        >
        ...
        <div class="list-container">
            ...
            >
                ...
                <el-table-column prop="des" label="动作" show-overflow-tooltip> </el-table-column>
                <el-table-column prop="createUserCN" label="创建人" width="200"> </el-table-column>
                <el-table-column prop="createTime" label="创建日期" width="160"> </el-table-column>
                <el-table-column label="操作" align="center" width="100">
                    <template slot-scope="scope">
                        <el-button size="small" type="text" @click="handleEdit(scope.row)" v-per="['alarm_sound_edit']"
                            >编辑</el-button
                        >
                        <el-button size="small" type="text" @click="handleDelete(scope.row)" v-per="['alarm_sound_del']"
                            >删除</el-button
                        >
                    </template>
                </el-table-column>
        ...
        <el-dialog title="添加配置" :visible.sync="addDialog" width="700px" custom-class="common-dialog">
            <el-form :model="addForm" :rules="rules" ref="addForm" label-position="top">
                        ...
                        <div class="ub ub-ver">
                            <div class="part-condition" v-for="(_item, _index) in addForm.rules" :key="_index">
                                ...
                                <el-select
                                    ...
                                    size="mini"
                                    style="margin: 0 0px; width: 100px"
                                    placeholder="请选择"
                                    @change="_item.val = ''"
                                >
                                    <el-option
                                ...
                                <span style="color: #dddddd"> — </span>
                                <el-input
                                    v-if="showValue(_item) === 'text' && _item.condition != 4 && _item.condition != 5"
                                    v-model="_item.val"
                                    clearable
                                    size="mini"
                                    style="width: 280px"
                                ...
                                ></el-input>
                                <el-select
                                    v-if="showValue(_item) === 'select' && _item.condition != 4 && _item.condition != 5"
                                    placeholder="请选择"
                                    style="width: 280px"
                                    v-model="_item.val"
                                    size="mini"
                                >
                                    <el-option
                                        v-for="(tag, _index) in _item.item"
                                        :label="tag.value"
                                        :value="tag.key"
                                        :key="_index"
                                    ></el-option>
                                ...
                                <i
                                    ...
                                    style="cursor: pointer; font-size: 14px; color: #ff0000; margin-left: 10px"
                                ></i>
                                <i
                                    class="el-icon-circle-plus-outline"
                                    style="font-size: 14px; color: #266fe8; margin-left: 10px; cursor: pointer"
                                    @click="addOneRule"
                                    v-if="_index == addForm.rules.length - 1"
                                ></i>
                            </div>
                            <!-- <p class="del-btn">
                ...
                <el-form-item
                    v-if="addForm.type !== '' && addForm.type == 0"
                    key="a"
                    label="提示语："
                    prop="warn"
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span @click.stop="listenMisuc(item)" style="float: right; color: #3aa6e4; font-size: 12px"
                                >试听</span
                            >
                        </el-option>
                    </el-select>
        ...
        <el-dialog title="编辑配置" :visible.sync="editDialog" width="700px" custom-class="common-dialog">
            <el-form :model="editForm" :rules="rules" ref="editForm" label-position="top">
                        ...
                        <div class="ub ub-ver">
                            <div class="part-condition" v-for="(_item, _index) in editForm.rules" :key="_index">
                                ...
                                <i
                                    class="el-icon-circle-plus-outline"
                                    style="font-size: 14px; color: #266fe8; margin-left: 10px; cursor: pointer"
                                    @click="addOneRuleEdit"
                                    v-if="_index == editForm.rules.length - 1"
                                ></i>
                            </div>
                            <!-- <p class="del-btn">
                ...
                <el-form-item
                    v-if="editForm.type !== '' && editForm.type == 0"
                    key="aa"
                    label="提示语："
                    prop="warn"
                    :label-width="formLabelWidth"
        ...
        <!--删除资源-->
        <DeleteDialog :dialogVisible="deleteDialog" @delete="handleDeleteFun" @cancel="deleteDialog = false">
        </DeleteDialog>
...
import alarm from '../common/audio/警报.wav';
import alarm2 from '../common/audio/警报2.wav';
import planeBells from '../common/audio/飞机上广播的钟声.wav';
import alarmBells from '../common/audio/警铃.wav';
import oh from '../common/audio/哦哦提示.wav';
import waterDrop from '../common/audio/水滴.wav';
import dripDrip from '../common/audio/水滴滴答.wav';
import danger from '../common/audio/危险信号.wav';
import systemAlarm from '../common/audio/系统告警.wav';
import signal from '../common/audio/信号.wav';
import inDanger from '../common/audio/遇到险情.wav';
import bells from '../common/audio/钟声.wav';
export default {
    name: 'AlarmConfig',
    data() {
        return {
            ...
            alarm: alarm,
            alarm2: alarm2,
            planeBells: planeBells,
            alarmBells: alarmBells,
            oh: oh,
            waterDrop: waterDrop,
            dripDrip: dripDrip,
            danger: danger,
