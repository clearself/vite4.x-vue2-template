<template>
    <div
        class="container rules-page"
        id="container"
        v-loading.lock="loading"
        element-loading-text="规则处理中......"
    ...
    >
        <div class="even-content" style="height: 90.5vh; overflow-y: auto; position: relative; overflow-x: hidden">
            ...
            <div class="rulesForm tree">
                ...
                >
                    <el-row>
                        <el-col :span="12">
                            <el-form-item
                                ...
                                style="margin-bottom: 16px; width: 92%"
                                class="first"
                            >
                                <el-input
                                    style="width: 100%"
                            ...
                            <el-form-item label="规则分组：" style="margin-bottom: 16px; width: 92%">
                                <div class="select-box ruleName">
                                    <div
                                        ...
                                        @click.stop="onOff = !onOff"
                                    >
                                        <div
                                            class="ub ub-f1 ub-ac"
                                            style="text-indent: 14px; font-size: 12px; line-height: 30px"
                                        >
                                            <span style="opacity: 0.7; font-size: 12px" v-if="!currentGroup"
                                                >请选择</span
                                            >{{ currentGroup }}
                                        </div>
                    ...
                    <el-form-item label="是否启用：" style="margin-bottom: 20px; width: 40%">
                        <div
                            ...
                            :class="{ yes: eventData.status, no: !eventData.status }"
                            @click="changeStatus"
                        >
                            <div
                                class="ub ub-ac ub-pj"
                                :style="{ background: eventData.status ? '#0052d9' : '#c5c5c5' }"
                            >
                                <div>是</div>
                                <div>否</div>
                            </div>
                                    ...
                                    <div class="handleTile" style="color: #fff">
                                        <div style="margin-left: 30px; position: relative">
                                            ...
                                            <div class="tree-line-vertical">
                                                <div
                                                    v-for="(item, index) in eventData.sourceList"
                                                    :key="index"
                                                    class="bg-area"
                                                >
                                                    <div class="one-type" v-if="item.type == 0">
                                                        <div class="tree-title ub ub-ac">
                                                            ...
                                                            >
                                                                <el-option
                                                                    v-for="(_item, _index) in testData"
                                                                    :value="_item.value"
                                                                    :label="_item.label"
                                                                    :key="_index"
                                                                ></el-option>
                                                            ...
                                                            <div
                                                                ...
                                                                v-if="
                                                                    item.objBindName ||
                                                                    slideWindow_sourceList[index].slideValue ||
                                                                    after_sourceList[index].afterType
                                                                "
                                                            >
                                                                <span v-if="item.objBindName">事件变量名：</span
                                                                ><span class="switch-color" style="color: #03864f">{{
                                                                    item.objBindName
                                                                }}</span>
                                                                <span
                                                                    v-if="slideWindow_sourceList[index].slideValue"
                                                                    style="margin-left: 5px"
                                                                    >滑动窗口：</span
                                                                ><span class="switch-color" style="color: #03864f">{{
                                                                    timeToStr(slideWindow_sourceList[index].slideValue)
                                                                }}</span>
                                                                <span
                                                                    v-if="after_sourceList[index].afterValue"
                                                                    style="margin-left: 10px"
                                                                    >时序变量名：</span
                                                                ><span class="switch-color" style="color: #03864f">{{
                                                                    after_sourceList[index].afterValue
                                                                }}</span>
                                                                <span
                                                                    v-if="after_sourceList[index].afterType"
                                                                    style="margin-left: 5px"
                                                                    >时间：</span
                                                                ><span class="switch-color" style="color: #03864f">{{
                                                                    timeToShow(after_sourceList[index].afterType)
                                                                }}</span>
                                                            </div>
                                                            <div
                                                                class="operate-btn"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <i
                                                                        ...
                                                                        style="color: #387dee"
                                                                        @click="openEventAttributeDialog(item, index)"
                                                                    ></i>
                                                                </el-tooltip>
                                                                ...
                                                                <el-dropdown trigger="click">
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="iconfont icon-xiangxiatianjia"
                                                                            style="
                                                                                font-size: 12px;
                                                                                color: #387dee;
                                                                                margin-right: 10px;
                                                                    ...
                                                                    >
                                                                        <el-dropdown-item
                                                                            data-type="1"
                                                                            @click.native="
                                                                                addEventData_down($event, index)
                                                                            "
                                                                            >数据源</el-dropdown-item
                                                                        >
                                                                        <el-dropdown-item
                                                                            data-type="2"
                                                                            @click.native="
                                                                ...
                                                                <el-dropdown trigger="click">
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="iconfont icon-xiangshangtianjia"
                                                                            style="
                                                                                font-size: 12px;
                                                                                color: #387dee;
                                                                                margin-right: 10px;
                                                                    ...
                                                                    <div class="inner-note">
                                                                        ...
                                                                        >
                                                                            <i
                                                                                ...
                                                                                @click="noteFlag = !noteFlag"
                                                                            ></i>
                                                                            <i
                                                                                style="font-size: 14px; color: #387dee"
                                                                                v-if="!noteFlag"
                                                    ...
                                                    <div class="two-type" v-if="item.type == 1">
                                                        <div class="tree-title ub ub-ac">
                                                            ...
                                                            <div
                                                                class="box-title"
                                                                v-if="
                                                                    item.countMap.constraintList[0].fieldBindName ||
                                                                    item.countMap.constraintList[0].operator ||
                                                                    item.countMap.constraintList[0].value
                                                                "
                                                            >
                                                                <span
                                                                    v-if="item.countMap.constraintList[0].fieldBindName"
                                                                    >变量名：</span
                                                                ><span class="switch-color" style="color: #d4d116">{{
                                                                    item.countMap.constraintList[0].fieldBindName
                                                                }}</span>
                                                                <span
                                                                    v-if="item.countMap.constraintList[0].operator"
                                                                    style="margin-left: 5px"
                                                                    >运算符：</span
                                                                ><span class="switch-color" style="color: #d4d116">{{
                                                                    item.countMap.constraintList[0].operator
                                                                ...
                                                                ><span
                                                                    ...
                                                                    class="switch-color"
                                                                    style="color: #d4d116"
                                                                    >{{ item.countMap.constraintList[0].value }}</span
                                                                >
                                                            </div>
                                                            <div class="operate-btn" style="margin-left: 10px">
                                                                ...
                                                                >
                                                                    <i
                                                                        class="iconfont icon-shuxing"
                                                                        style="color: #387dee"
                                                                        @click="openAccmulateDialog(item, index)"
                                                                    ></i>
                                                                </el-tooltip>
                                                        ...
                                                        <div
                                                            class="one-module tree-line-count"
                                                            style="padding-left: 40px; position: relative"
                                                        >
                                                            <i
                                                                @click.stop="toogleChild_countInner"
                                                                :class="{
                                                                    'el-icon-caret-right': true,
                                                                    'is-show': true,
                                                                    'fold-arrow-inner': true,
                                                                }"
                                                                style="
                                                                    position: absolute;
                                                                    cursor: pointer;
                                                            ...
                                                            ></i>
                                                            <div
                                                                class="tree-title tree-title-accumulate ub ub-ac"
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    class="box-title"
                                                                    v-if="
                                                                        item.factMap.objBindName ||
                                                                        slideWindow_sourceList[index].slideValue ||
                                                                        after_sourceList[index].afterType
                                                                    "
                                                                >
                                                                    <span v-if="item.factMap.objBindName"
                                                                        >事件变量名：</span
                                                                    ><span
                                                                        class="switch-color"
                                                                        style="color: #03864f"
                                                                        >{{ item.factMap.objBindName }}</span
                                                                    >
                                                                    <span
                                                                        v-if="slideWindow_sourceList[index].slideValue"
                                                                        style="margin-left: 5px"
                                                                    ...
                                                                    ><span
                                                                        class="switch-color"
                                                                        style="color: #03864f"
                                                                        >{{ after_sourceList[index].afterValue }}</span
                                                                    >
                                                                    <span
                                                                        v-if="after_sourceList[index].afterType"
                                                                        style="margin-left: 5px"
                                            ...
                                            <div
                                                style="
                                                    ...
                                                    position: relative;
                                                "
                                                class="tree-line-outer"
                                            >
                                                <i
                                                    class="el-icon-caret-right"
                                                    style="color: #387dee; font-size: 18px"
                                                ></i>
                                                <el-dropdown trigger="click">
                                                    <i
                                                    ...
                                                    <el-dropdown-menu slot="dropdown" :append-to-body="false">
                                                        <el-dropdown-item data-type="1" @click.native="addEventData"
                                                            >数据源</el-dropdown-item
                                                        >
                                                        <el-dropdown-item data-type="2" @click.native="addEventData"
                                                            >累计</el-dropdown-item
                                                        >
                                                    </el-dropdown-menu>
                                                </el-dropdown>
                ...
                >
                    <el-form ref="addRuleAtt_Form" label-width="100px" label-position="top">
                        <el-form-item label="变量名：" style="margin-bottom: 10px">
                            <el-input
                                v-model.trim="boundName"
                                placeholder="请输入以$开头的英文变量名"
                                @blur="judgeBoundName(boundName)"
                                size="small"
                                style="width: 100%"
                            ></el-input>
                        </el-form-item>
                        <el-form-item label="滑动窗口：" style="margin-bottom: 10px">
                            ...
                            <span
                                style="color: #ddd; margin: 0 9px"
                                v-if="this.slideType === 'time' || this.slideType === 'length'"
                                >—-</span
                            >
                            <el-time-picker
                                class="guding"
                        ...
                        <el-form-item label="AFTER：" style="margin-bottom: 10px">
                            ...
                            <el-input
                                v-model.trim="afterValue"
                                size="small"
                                @blur="judgeAfter(afterValue)"
                                placeholder="变量名"
                                style="width: 190px"
                            ></el-input>
                        </el-form-item>
                ...
                <!-- 累计属性 -->
                <el-dialog title="累计属性" width="700px" :visible.sync="accmulateDialog" custom-class="common-dialog">
                    <el-form ref="addRuleAtt_Form" label-width="80px" label-position="top">
                        <el-form-item label="变量名：" style="margin-bottom: 10px">
                            <el-input
                                v-model.trim="accmulateForm.fieldBindName"
                                @blur="judgeFieldBindName(accmulateForm.fieldBindName)"
                                placeholder="请输入以$开头的英文变量名"
                                size="small"
                                style="width: 100%"
                            ></el-input>
                ...
                >
                    ...
                    >
                        <el-table-column
                            ...
                            type="index"
                            width="50"
                            :index="indexMethod_resource"
                            label="序号"
                        >
                        </el-table-column>
                        <el-table-column prop="poolName" label="资源池名称" show-overflow-tooltip> </el-table-column>
                    ...
                    <pagination
                        v-show="total_num_resource > 0"
                        :total="total_num_resource"
                        :page.sync="get_params_resource.page"
                        :limit.sync="get_params_resource.size"
                        @pagination="get_data_resource"
                    />
                </el-dialog>
                ...
                >
                    ...
                    <pagination
                        v-show="total_num_extend > 0"
                        :total="total_num_extend"
                        :page.sync="get_params_extend.page"
                        :limit.sync="get_params_extend.size"
                        @pagination="get_data_extend"
                    />
                    <div slot="footer" class="dialog-footer">
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="变量：" label-width="60px">
                                    ...
                                    >
                                        <el-option
                                            v-for="(item, index) in variate_arr_one"
                                            :key="index"
                                            :label="item.var"
                                            :value="item.var"
                                        ></el-option>
                ...
                <div class="output-box">
                    <ul class="showcase_then" style="margin-left: -20px; padding-top: 0px">
                        <li v-for="(int, ind) in this.eventData.thenList" :key="ind + 'c'">
                                    ...
                                    <el-row type="flex" align="middle">
                                            ...
                                            :class="{
                                                'is-required':
                                                    ...
                                                    ([
                                                        ...
                                                        eventData.thenList[8].value === '1'),
                                                'required-msg': requiredFlag && int.value === '',
                                            }"
                                            v-if="ind <= 14"
                                        >
                                            <el-select
                                        ...
                                        <el-col style="width: 20px" v-if="ind >= 14">
                                            <i
                                                ...
                                                class="el-icon-plus"
                                                style="cursor: pointer; font-size: 14px; color: #387dee"
                                            ></i>
                                        </el-col>
                                        <el-col style="width: 20px" v-if="ind > 14">
                                            <i
            ...
            <div
                ...
                class="right_btn"
                style="position: fixed; top: 75px; right: 10px; z-index: 100"
            >
                <el-button
                    ...
                    size="small"
                    @click="$router.push('/rule/rule_new_rules_type')"
                    >取消</el-button
                >
                <el-button class="releaseBtn" size="small" type="primary" @click="submitRule('rulesForm')"
                    >确认</el-button
                >
            </div>
        </div>
...
import { get_rule_tree, get_order_template, get_order_user } from '../../server/rule/inspection';
...
export default {
    ...
    watch: {
        activeName: {
            handler(newVal, oldVal) {
                if (newVal) {
                    newVal === 'first'
                        ? (this.eventData.mark = 1)
                        : (this.eventData.mark = 2) && (this.eventData.extends = '');
                }
            },
        },
    ...
    methods: {
        ...
        async get_data_fields() {
            ...
            let err;
            if (!list.length) {
                [err, list] = await get_fields(data)
                    .then((res) => {
                        return [null, res];
                    })
                    .catch((err) => {
        ...
        openAccmulateDialog(item, index) {
            ...
            this.accmulateForm.fieldBindName = this.record_fieldBindName =
                item.countMap.constraintList[0].fieldBindName;
        ...
        accmulateDialogSuccess() {
            ...
            this.eventData.sourceList[this.countIndex].countMap.constraintList[0].fieldBindName =
                this.accmulateForm.fieldBindName;
            this.eventData.sourceList[this.countIndex].countMap.constraintList[0].operator =
                this.accmulateForm.operator;
        ...
        sendModelData() {
            ...
            if (
                this.eventData.thenList[0]?.value === '' ||
                this.eventData.thenList[1]?.value === '' ||
                this.eventData.thenList[2]?.value === ''
            ) {
            ...
            data.sourceList.forEach((item, index) => {
                if (item.type == '0') {
                    ...
                    if (
                        this.slideWindow_sourceList[index] &&
                        this.slideWindow_sourceList[index].slideType &&
                        this.slideWindow_sourceList[index].slideValue.trim()
                    ) {
                        item.window =
                            'over window:' +
                            this.slideWindow_sourceList[index].slideType +
                            '(' +
                            this.timeToStr(this.slideWindow_sourceList[index].slideValue) +
                            ')';
                    } else {
                        item.window = '';
                    }
                    if (
                        this.after_sourceList[index] &&
                        this.after_sourceList[index].afterType &&
                        this.after_sourceList[index].afterValue.trim()
                    ) {
                        if (this.after_sourceList[index].timeSign === 'range') {
                            item.after =
                                '[' +
                                this.timeToStr(this.after_sourceList[index].afterType[0]) +
                                ',' +
                                this.timeToStr(this.after_sourceList[index].afterType[1]) +
                                ']' +
                                ' ' +
                                this.after_sourceList[index].afterValue;
                        } else if (this.after_sourceList[index].timeSign === 'fixed') {
                            item.after =
                                '[' +
                                this.timeToStr(this.after_sourceList[index].afterType) +
                                ']' +
                                ' ' +
                                this.after_sourceList[index].afterValue;
                        }
...
.inner-note ::v-deep .el-input__inner,
.container ::v-deep .el-textarea__inner,
.inner-note ::v-deep .el-textarea__inner {
    // background-color: transparent !important;
...
.showcase ::v-deep .line-put .el-input__inner,
...
.bottom_3 .el-input ::v-deep .el-input__inner,
.bottom_4 .el-input ::v-deep .el-input__inner {
    height: 20px;
    line-height: 20px;
}
...
.container ::v-deep .el-tabs,
.container ::v-deep .el-tabs .el-tab-pane {
    font-size: 12px;
...
.container ::v-deep .el-input.is-focus {
    border-color: #409eff;
...
.container ::v-deep .el-button.is-disabled,
...
.rulesForm ::v-deep .el-input-group__append,
.rulesForm ::v-deep .el-input-group__prepend {
